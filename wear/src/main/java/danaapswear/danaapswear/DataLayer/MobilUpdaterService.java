package danaapswear.danaapswear.DataLayer;
...
public class MobilUpdaterService extends WearableListenerService implements
        GoogleApiClient.ConnectionCallbacks,
        GoogleApiClient.OnConnectionFailedListener {
    public static final String ACTION_RESEND = MobilUpdaterService.class.getName().concat(".Resend");
    public static final String ACTION_OPEN_SETTINGS = MobilUpdaterService.class.getName().concat(".OpenSettings");
